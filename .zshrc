...
#keyboard
alias qwerty-us="setxkbmap us"
alias qwerty-cz="setxkbmap cz"
...
# connect to a wifi
alias wifiPFKP-private="nmcli device wifi connect PFKP-private password"
alias wifisvedova="nmcli device wifi connect svedova password"
...
#__conda_setup="$('/home/jezura777/anaconda3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
#if [ $? -eq 0 ]; then
#    eval "$__conda_setup"
#else
#    if [ -f "/home/jezura777/anaconda3/etc/profile.d/conda.sh" ]; then
#        . "/home/jezura777/anaconda3/etc/profile.d/conda.sh"
#    else
#        export PATH="/home/jezura777/anaconda3/bin:$PATH"
#    fi
#fi
#unset __conda_setup
# <<< conda initialize <<<
